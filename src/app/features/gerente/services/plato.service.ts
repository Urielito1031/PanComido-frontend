...
export const PLATO_ENDPOINTS = {
  base: `${environment.apiUrl}/plato`,
  crear: `${environment.apiUrl}/plato`,
  actualizar: (id: number) => `${environment.apiUrl}/plato/${id}`,
  eliminar: (id: number) => `${environment.apiUrl}/plato/${id}`
};
  ...
  private platosList = signal<Plato[]>([
    {
      ...
      descripcion: 'Milanesa con salsa y queso',
      platoDelDia: true,
      tiempo: 25,
      tipo: 'principal',
      bebida: '',
    ...
    },
    {
      ...
      descripcion: 'Pasta casera con pesto',
      platoDelDia: false,
      tiempo: 20,
      tipo: 'principal',
      bebida: '',
    ...
    },
    {
      ...
      descripcion: 'Pizza clásica con muzarella',
      platoDelDia: false,
      tiempo: 30,
      tipo: 'principal',
      bebida: '',
    ...
    },
    {
      ...
      descripcion: 'Pastel de papa casero',
      platoDelDia: false,
      tiempo: 35,
      tipo: 'principal',
      bebida: '',
    ...
    },
    {
      ...
      descripcion: 'Pollo con salsa curry',
      platoDelDia: false,
      tiempo: 40,
      tipo: 'principal',
      bebida: '',
    ...
    },
    {
      ...
      descripcion: 'Cerdo con salsa especial',
      platoDelDia: false,
      tiempo: 45,
      tipo: 'principal',
      bebida: '',
